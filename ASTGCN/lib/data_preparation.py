...
def read_and_generate_dataset2(graph_signal_matrix_filename,
    ...
    train_week, train_day, train_hour, train_target = \
        mdata['train']['XQ'].transpose((0, 2, 3, 1)), \
        mdata['train']['XP'].transpose((0, 2, 3, 1)), \
        mdata['train']['XC'].transpose((0, 2, 3, 1)), \
        mdata['train']['Y']
    val_week, val_day, val_hour, val_target = \
        mdata['val']['XQ'].transpose((0, 2, 3, 1)), \
        mdata['val']['XP'].transpose((0, 2, 3, 1)), \
        mdata['val']['XC'].transpose((0, 2, 3, 1)), \
        mdata['val']['Y']
    test_week, test_day, test_hour, test_target = \
        mdata['test']['XQ'].transpose((0, 2, 3, 1)), \
        mdata['test']['XP'].transpose((0, 2, 3, 1)), \
        mdata['test']['XC'].transpose((0, 2, 3, 1)), \
        mdata['test']['Y']
